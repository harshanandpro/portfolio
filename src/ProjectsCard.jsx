...
const ProjectsCard = ({ name, photo, desc, link, moreImages = [], setPreviewImages }) => {
  return (
    <div className="projects_projects">
      <div className="projects_image">
        <img
          ...
          src={photo}
          alt={name}
          onMouseEnter={() => setPreviewImages(moreImages)}
      ...
      <div className="projects_texts">
        ...
        {link && (
          <a className="projects_link" href={link} target="_blank" rel="noopener noreferrer">
